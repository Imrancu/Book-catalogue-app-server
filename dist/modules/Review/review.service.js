...
exports.getReviewService = exports.createReviewService = void 0;
...
const getReviewService = (bookId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield review_model_1.Review.find({ bookId: bookId });
    return result;
});
